<div x-cloak class="h-6">
    ...
    <button x-show="darkMode === 'dark'" x-on:click="darkMode = 'system'"
            class="text-gray-500 hover:text-gray-400 focus:outline-none rounded-lg text-sm">
    ...
    <button x-show="darkMode === 'system'" x-on:click="darkMode = 'light'"
            class="text-gray-400 hover:text-gray-500 focus:outline-none rounded-lg text-sm">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            <path fill="currentColor"
