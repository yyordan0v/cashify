...
{{--            layout: default/expanded --}}
        ...
        <template x-for="(toast, index) in toasts" :key="toast.id">
            ...
            >
                    <span
                        class="relative flex flex-col items-start shadow-[0_5px_15px_-3px_rgb(0_0_0_/_0.08)] w-full transition-all duration-300 ease-out bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-600/20 sm:rounded-lg sm:max-w-xs group"
                    ...
                    >
                                ...
                                <div class="flex items-center"
                                    ...
                                    <svg x-show="toast.type=='warning'" class="w-[18px] h-[18px] mr-1.5 -ml-1"
                                         viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path
                                            ...
                                            fill="currentColor"></path></svg>
                                    <svg x-show="toast.type=='error'" class="w-[18px] h-[18px] mr-1.5 -ml-1"
                                         viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path
                                            fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="currentColor"></path></svg>
                                    <p class="text-[13px] font-medium leading-none text-gray-800 dark:text-gray-100"
                                       x-text="toast.message"></p>
                                </div>
                                <p x-show="toast.description"
                                   :class="{ 'pl-5' : toast.type!='default' }"
                                   class="mt-1.5 text-xs leading-none opacity-70 dark:text-gray-200"
                        ...
                        <span
                            ...
                            class="absolute right-0 p-1.5 mr-2.5 text-gray-400 duration-100 ease-in-out rounded-full opacity-0 cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-50 hover:text-gray-500"
