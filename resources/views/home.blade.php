        ...
        <div class="container px-6 py-32 mx-auto md:text-center md:px-4">
            ...
            <div
                class="flex flex-col items-center justify-center mt-20 space-y-4 text-center sm:flex-row sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="{{ route('login') }}"
                       class="inline-flex items-center justify-center w-full px-8 py-4 text-base font-medium leading-6 text-gray-900 bg-white border border-transparent transition-colors duration-150 rounded-full xl:px-10 md:w-auto hover:bg-neutral-200 focus:outline-none">Get Started</a>
                </span>
            </div>
        </div>
    </section>
