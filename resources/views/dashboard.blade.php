<x-app-layout>
    ...
    <aside
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 bg-blue-500/13 dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors"
        ...
        <div class="mx-4">
            ...
            <div
                ...
                <div class="flex-auto w-full p-4 pt-0 text-center">
                    <div class="transition-all duration-200 ease-nav-brand">
                        ...
                        <p class="mb-0 text-xs font-semibold leading-tight dark:opacity-60">Please check
                            our docs</p>
                    </div>
                </div>
            </div>
            <a href="https://www.creative-tim.com/learning-lab/tailwind/html/quick-start/argon-dashboard/"
               target="_blank"
               class="inline-block w-full px-8 py-2 mb-4 text-xs font-bold leading-normal text-center text-black capitalize transition-all ease-in rounded-lg shadow-md bg-slate-700 bg-150 hover:shadow-xs hover:-translate-y-px">Documentation</a>
            <!-- pro btn  -->
            <a class="inline-block w-full px-8 py-2 text-xs font-bold leading-normal text-center text-black align-middle transition-all ease-in bg-blue-500 border-0 rounded-lg shadow-md select-none bg-150 bg-x-25 hover:shadow-xs hover:-translate-y-px"
    ...
    <main class="relative h-full max-h-screen transition-all duration-200 ease-in-out ml-[17rem] rounded-xl">
        <!-- Navbar -->
        <nav
                                        ...
                                        <div class="flex py-1">
                                            <div class="my-auto">
                                                <img src="../assets/img/team-2.jpg"
                                                     class="inline-flex items-center justify-center mr-4 text-sm text-black h-9 w-9 max-w-none rounded-xl"/>
                                            </div>
                                        ...
                                        <div class="flex py-1">
                                            <div class="my-auto">
                                                <img src="../assets/img/small-logos/logo-spotify.svg"
                                                     class="inline-flex items-center justify-center mr-4 text-sm text-black bg-gradient-to-tl from-zinc-800 to-zinc-700 dark:bg-gradient-to-tl dark:from-slate-750 dark:to-gray-850 h-9 w-9 max-w-none rounded-xl"/>
                                            </div>
                                            <div class="flex flex-col justify-center">
                                                <h6 class="mb-1 text-sm font-normal leading-normal">
                                ...
                                <li class="relative">
                                    <a class="dark:hover:bg-slate-900 ease py-1.2 clear-both block w-full whitespace-nowrap rounded-lg px-4 transition-colors duration-300 hover:bg-gray-200 hover:text-slate-700"
                                       href="javascript:">
                                        <div class="flex py-1">
                                            <div
                                                class="inline-flex items-center justify-center my-auto mr-4 text-sm text-black transition-all duration-200 ease-nav-brand bg-gradient-to-tl from-slate-600 to-slate-300 h-9 w-9 rounded-xl">
                            ...
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        ...
                                        <i class="ni leading-none ni-world text-lg relative top-3.5 text-black"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        ...
                                        <i class="ni leading-none ni-paper-diploma text-lg relative top-3.5 text-black"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        ...
                                        <i class="ni leading-none ni-cart text-lg relative top-3.5 text-black"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
                    <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
                        ...
                        <div slide class="absolute w-full h-full transition-all duration-500">
                            ...
                            <div
                                class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-black">
                                <div
                                ...
                                <h5 class="mb-1 text-black">Get started with Argon</h5>
                        ...
                        <div slide class="absolute w-full h-full transition-all duration-500">
                            ...
                            <div
                                ...
                                <h5 class="mb-1 text-black">Faster way to create web pages</h5>
                        ...
                        <div slide class="absolute w-full h-full transition-all duration-500">
                            ...
                            <div
                                ...
                                <h5 class="mb-1 text-black">Share with us your design tips!</h5>
                        ...
                        <!-- Control buttons -->
                        <button btn-next
                                class="absolute z-10 w-10 h-10 p-2 text-lg text-black border-none opacity-50 cursor-pointer hover:opacity-100 far fa-chevron-right active:scale-110 top-6 right-4"></button>
                        <button btn-prev
                                class="absolute z-10 w-10 h-10 p-2 text-lg text-black border-none opacity-50 cursor-pointer hover:opacity-100 far fa-chevron-left active:scale-110 top-6 right-16"></button>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-t-lg rounded-xl text-inherit">
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <i class="text-black ni ni-mobile-button relative top-0.75 text-xxs"></i>
                                        </div>
                                    ...
                                    <div class="flex">
                                        <button
                                            class="group ease-in leading-pro text-xs rounded-3.5xl p-1.2 h-6.5 w-6.5 mx-0 my-auto inline-block cursor-pointer border-0 bg-transparent text-center align-middle font-bold text-slate-700 shadow-none transition-all">
                                ...
                                <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-xl text-inherit">
                                    <div class="flex items-center">
                                        <div
                                            class="inline-block w-8 h-8 mr-4 text-center text-black bg-center shadow-sm fill-current stroke-none bg-gradient-to-tl from-zinc-800 to-zinc-700 dark:bg-gradient-to-tl dark:from-slate-750 dark:to-gray-850 rounded-xl">
                                            <i class="text-black ni ni-tag relative top-0.75 text-xxs"></i>
                                        </div>
                                        <div class="flex flex-col">
                                            <h6 class="mb-1 text-sm leading-normal text-slate-700">
                                                Tickets</h6>
                                ...
                                <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-b-lg rounded-xl text-inherit">
                                    <div class="flex items-center">
                                        <div
                                            class="inline-block w-8 h-8 mr-4 text-center text-black bg-center shadow-sm fill-current stroke-none bg-gradient-to-tl from-zinc-800 to-zinc-700 dark:bg-gradient-to-tl dark:from-slate-750 dark:to-gray-850 rounded-xl">
                                            <i class="text-black ni ni-box-2 relative top-0.75 text-xxs"></i>
                                        </div>
                                        <div class="flex flex-col">
                                ...
                                <li class="relative flex justify-between py-2 pr-4 border-0 rounded-b-lg rounded-xl text-inherit">
                                    <div class="flex items-center">
                                        <div
                                            class="inline-block w-8 h-8 mr-4 text-center text-black bg-center shadow-sm fill-current stroke-none bg-gradient-to-tl from-zinc-800 to-zinc-700 dark:bg-gradient-to-tl dark:from-slate-750 dark:to-gray-850 rounded-xl">
                                            <i class="text-black ni ni-satisfied relative top-0.75 text-xxs"></i>
                                        </div>
                                        <div class="flex flex-col">
