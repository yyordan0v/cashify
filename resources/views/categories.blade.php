            ...
            <x-tabs.content class="flex flex-col gap-4">
                ...
                <x-panels.panel padding="4">
                    <div class="flex items-center">
                        ...
                        <x-category-image currentImage="shopping" background="bg-fuchsia-200"/>
                    ...
                    <div class="flex flex-col items-start w-full">
                        ...
                        <div class="flex items-center w-full">
                            ...
                            <div x-data="{ slideOverOpen: false }" class="relative z-50 w-auto h-auto">
                                ...
                                <x-category-image-change currentImage="shopping" background="bg-fuchsia-200"/>
                                    ...
                                    <div x-show="slideOverOpen" @keydown.window.escape="slideOverOpen=false"
                                        ...
                                        <div class="fixed inset-0 overflow-hidden">
                                            <div class="absolute inset-0 overflow-hidden">
                                                <div class="fixed inset-x-0 bottom-0 flex h-3/4 max-h-3/4">
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="px-4 sm:px-5">
                                                                <div class="flex items-start justify-between pb-1">
                                                                    <h2 class="text-base font-semibold leading-6 text-gray-900"
                                                                        id="slide-over-title">Choose Category Image</h2>
                                                            ...
                                                            <div class="relative flex-1 px-4 mt-5 sm:px-5">
                                                                <div class="absolute inset-0 px-4 sm:px-5">
                                                                    <div
                                                                        class="relative h-full overflow-hidden border border-dashed rounded-md border-neutral-300"></div>
                                                                    <div
                                                                        class="relative h-full overflow-hidden border border-dashed rounded-md border-neutral-300"></div>
                                                                    <div
                                                                        class="relative h-full overflow-hidden border border-dashed rounded-md border-neutral-300"></div>
            ...
            <x-tabs.content class="flex flex-col gap-4">
                <x-panels.panel padding="4">
                    <div class="flex items-center">
                        ...
                        <x-category-image background="bg-amber-200" currentImage="gift"/>
                ...
                <x-panels.panel padding="4">
                    <div class="flex items-center">
                        ...
                        <x-category-image background="bg-lime-200" current-image="dollar-coin"/>
